// hijri-date.js
//from https://github.com/arabiaweather/hijri-date
...
function basecal(date, adjust){
	var today = date;
	if(adjust) {
		//how many millisecs to adjust
        var adjustmili = 1000*60*60*24*adjust;
        //how many millisecs it has been since the beginning of time
...
export function convert(date, adjustment) {
	var wdNames = new Array('الأحد','الاثنين','الثلاثاء','الأربعاء','الخميس','الجمعة','السبت');
	var iMonthNames = ["Muḥarram", "Safar", "Rabi al-Awwal", "Rabi al-Thani", "Jumada al-Awwal", "Jumada al-Thani", "Rajab", "Shaban", "Ramadan", "Shawwal", "Dhu al-Qadah", "Dhu al-Hijjah"]
